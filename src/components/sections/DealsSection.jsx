...
const scrollToMenuWithCategory = (category) => {
    ...
    >
      ...
      <div className="deals-grid">
        ...
        <motion.div
          ...
          onClick={scrollToMenuWithCategory}
        ...
        >
          ...
          <div className="deal-bottom">
            ...
            <button
              ...
              onClick={e => {
                e.stopPropagation();
                scrollToMenuWithCategory('burgers');
              }}
            >
              Shop burgers →
            </button>
        ...
        <div className="deals-secondary">
          {SECONDARY_DEALS.map((deal, i) => (
            <motion.div
              ...
              custom={i}
              style={{ cursor: 'pointer' }}
              onClick={() => scrollToMenuWithCategory(deal.category)}
            >
              <div>
              ...
              <button
                ...
                onClick={e => {
                  e.stopPropagation();
                  scrollToMenuWithCategory(deal.category);
                }}
              >
                {deal.cta}
              </button>
