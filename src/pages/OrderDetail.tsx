...
export default function OrderDetail() {
  ...
  if (loading) {
    return layout(<div className="order-skeleton" style={{ height: 300, borderRadius: '1rem' }} />);
  }
      ...
      <main className="orders-page">
        <div className="orders-container">
          ...
          >
            ...
            {isCancelled && (
              <div className="order-cancelled-notice">❌ This order was cancelled</div>
            )}
              ...
              <div className="order-review-section">
                ...
                {reviewLoading ? (
                  ...
                  <div className="order-review-submitted">
                    ...
                    <button
                      className="order-review-edit-btn"
